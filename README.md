  ...
  <header class="border-b">
    <div class="max-w-6xl mx-auto flex items-center justify-between p-6">
      <a href="#" class="flex items-center gap-3 justify-start">
        <div class="w-12 h-12 rounded-full bg-black text-white flex items-center justify-center font-semibold text-lg">HE</div>
        <div>
          <div class="text-lg font-semibold">Haute Estates</div>
          <div class="text-sm text-gray-500">Curated Luxury Living Marketing</div>
        </div>
      </a>
      <nav class="hidden md:flex gap-6 items-start text-base">
